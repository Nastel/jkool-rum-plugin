...
if (('performance' in window) & ('timing' in window.performance)
	...
	window.addEventListener('load', function() {
		...
		for (var i = 0; i < perfEntries.length; i++) {
			...
			// var myJSONData =
			// '{"tracking-id":"51191015-1783-4f63-b91e-7e17e8e33333","status":"END","time-usec":"1444679553236000","operation":"Performance","source_fqn":"APPL=WebOrders#SERVER=WebServer100#NETADDR=11.0.0.2#DATACENTER=DC1#GEOADDR=New
			// York, NY"}';
			// $.ajax({
			// type: 'POST',
			...
			// alert("HelloStatus: " + textStatus); alert("HelloError: " +
			// errorThrown);
			// },
			// statusCode: {
			// 202: function() {
